                        ...
                        >
                            <div className={`absolute inset-0 flex items-start pt-8 md:pt-12 ${isUz ? "bg-gradient-to-r from-blue-900/90 to-transparent" : "bg-gradient-to-r from-[#FE9B19]/90 to-transparent"}`}>
                                <div className="container mx-auto px-8 md:px-16 max-w-2xl">
                                    ...
                                    <p className="text-white/95 text-base md:text-lg mb-8 font-medium drop-shadow-sm">
                                        {slide.description}
                                    </p>
                                    {slide.button_text && slide.button_url && (
                                        <a
                                            href={slide.button_url}
                                            className={`inline-flex items-center gap-2 bg-white px-8 py-3 rounded-full font-bold transition-all transform hover:scale-105 shadow-xl ${isUz ? "text-blue-600 hover:bg-blue-50" : "text-[#FE9B19] hover:bg-orange-50"}`}
                                        >
                                            {slide.button_text}
