...
if (typeof window !== "undefined") {
    ...
    console.log("PDF Worker configured using cdnjs");
}
                    ...
                    <div className="flex flex-col items-center w-full max-w-4xl gap-6">
                        ...
                        >
                            <Document
                                ...
                                error={
                                    <div className="text-red-500 p-8 text-center bg-white rounded-xl shadow-sm">
                                        <div className="text-4xl mb-4">⚠️</div>
                                        <p>Kitob faylini yuklashda xatolik yuz berdi.</p>
                                    </div>
                                }
                            >
                                <Page
